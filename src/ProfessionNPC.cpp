...
public:
    ...
    bool OnGossipHello(Player *player, Creature *creature) override
    {
        ...
        AddGossipItemFor(player, GOSSIP_ICON_TRAINER, "制皮", GOSSIP_SENDER_MAIN, SKILL_LEATHERWORKING);
        AddGossipItemFor(player, GOSSIP_ICON_TRAINER, "裁缝", GOSSIP_SENDER_MAIN, SKILL_TAILORING);
        ...
        AddGossipItemFor(player, GOSSIP_ICON_TRAINER, "珠宝加工", GOSSIP_SENDER_MAIN, SKILL_JEWELCRAFTING);
        AddGossipItemFor(player, GOSSIP_ICON_TRAINER, "铭文", GOSSIP_SENDER_MAIN, SKILL_INSCRIPTION);
        ...
        AddGossipItemFor(player, GOSSIP_ICON_TRAINER, "钓鱼", GOSSIP_SENDER_MAIN, SKILL_FISHING);
